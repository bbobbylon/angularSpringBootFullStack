...
[[ -n "$DOMAIN" ]]      || die "--domain is required  (e.g. --domain app.tessera.example.com)"
[[ -n "$AIVEN_HOST" ]]  || die "--aiven-host is required"
